...
def upgrade():
    ...
    op.create_table('experiments',
                    ...
                    sa.Column('start_voltage', sa.DECIMAL(precision=9, scale=4), nullable=False),
                    sa.Column('end_voltage', sa.DECIMAL(precision=9, scale=4), nullable=False),
                    sa.Column('scan_rate', sa.DECIMAL(precision=9, scale=4), nullable=False),
